...
//        
//        // Better fallback that respects decimal formatting
//        if let formattedString = formatter.string(from: price as NSDecimalNumber) {
//            return formattedString
//        } else {
//            // Fallback with proper decimal formatting
//            let decimalPrice = NSDecimalNumber(decimal: price)
//            let roundedPrice = decimalPrice.rounding(accordingToBehavior: NSDecimalNumberHandler(
//                roundingMode: .plain,
//                scale: 2,
